"""
Report generator for Verdanta application.
...
sns.set_palette("husl")  # Use seaborn's husl palette for consistent colors
...
class ReportGenerator:
    ...
    def create_scope_pie_chart(self, data):
        ...
        # Apply light theme
        theme_config = self.get_light_theme_config()
        fig.update_layout(
            legend_title="Scope",
            font=dict(size=12),
    ...
    def get_light_theme_config(self):
        """Get light theme configuration for plotly charts"""
        return {
            'layout': {
                'plot_bgcolor': '#ffffff',
                'paper_bgcolor': '#ffffff',
                'font': {'color': '#262730'},
                'colorway': ['#2E7D32', '#388E3C', '#4CAF50', '#66BB6A', '#81C784', '#A5D6A7', '#C8E6C9', '#E8F5E9']
            }
        }
