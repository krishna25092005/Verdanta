"""
Configuration settings for Verdanta application.
"""
...
APP_AUTHOR = "Krishna Chauhan"
APP_CONTACT = "krishna.chauhan4@s.amity.edu"

# API keys
GROQ_API_KEY = os.getenv("GROQ_API_KEY")

# Theme settings
THEME_MODE = "dark"  # Use dark mode for better visibility and contrast
